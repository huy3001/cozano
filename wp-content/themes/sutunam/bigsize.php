			...
			<div class="bigsize-option-1 content-block <?php if($loop->have_posts()) echo 'has-feature'; ?>">
                ...
                <div class="content-block-img">
                    ...
                    <?php endif; ?>
                        ...
                        ?>
                        <picture>
                            <source media="(min-width:992px)" data-srcset="<?php echo $jk_options['bigsize_img_option_1']['url'] ?>">
                            <source media="(min-width:480px)" data-srcset="<?php echo $bigsize_img_option_1_tablet ?>">
                            <img class="lazyload" src="<?php echo $base64_image ?>" data-src="<?php echo $bigsize_img_option_1_mobile ?>" alt="">
                        </picture>
                        <?php endif; ?>
                    <?php if($jk_options['bigsize_url_option_1']): ?>
                    </a>
            ...
            <div class="bigsize-option-2 content-block <?php if($loop->have_posts()) echo 'has-feature'; ?>">
                ...
                <div class="content-block-img">
                    ...
                    <?php endif; ?>
                        ...
                        ?>
                        <picture>
                            <source media="(min-width:992px)" data-srcset="<?php echo $jk_options['bigsize_img_option_2']['url'] ?>">
                            <source media="(min-width:480px)" data-srcset="<?php echo $bigsize_img_option_2_tablet ?>">
                            <img class="lazyload" src="<?php echo $base64_image ?>" data-src="<?php echo $bigsize_img_option_2_mobile ?>" alt="">
                        </picture>
                        <?php endif; ?>
                    <?php if($jk_options['bigsize_url_option_2']): ?>
                    </a>
            ...
            <div class="bigsize-option-3 content-block <?php if($loop->have_posts()) echo 'has-feature'; ?>">
                ...
                <div class="content-block-img">
                    ...
                    <?php endif; ?>
                        ...
                        ?>
                        <picture>
                            <source media="(min-width:992px)" data-srcset="<?php echo $jk_options['bigsize_img_option_3']['url'] ?>">
                            <source media="(min-width:480px)" data-srcset="<?php echo $bigsize_img_option_3_tablet ?>">
                            <img class="lazyload" src="<?php echo $base64_image ?>" data-src="<?php echo $bigsize_img_option_3_mobile ?>" alt="">
                        </picture>
                        <?php endif; ?>
                    <?php if($jk_options['bigsize_url_option_3']): ?>
                    </a>
