    ...
    h.prototype.init = function () {
        ...
        if(i === 'màu sắc' ){
            for (n, s = 0; s < n.length; s++){
                h = n[s];
                var res = h.split("-");
                e += "<li class='filter-color' data-count='" + this._fields[i][h] + "' data-color='"+res[1]+"'>" + res[0] + "<div style='display: none'>-"+res[1]+"</div></li>";
            }
        }else{
        ...
        this._menu[t].highlight.addClass("ft-hidden")
        ...
        this._menu[t].mismatch.addClass("ft-hidden")
        ...
        this.hideMismatch(i), this._menu[i].tags.children().not(this._menu[i].active).each(function () {
            (this.textContent || this.innerText).toUpperCase().indexOf(e.toUpperCase()) >= 0 ? (t(this).removeClass("ft-hidden"), s += 1) : t(this).addClass("ft-hidden")
