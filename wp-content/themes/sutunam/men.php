...
<div class="right-content">
	...
	<div class="container">
		<div class="row">
            ...
            ?>
            <div class="men-option-1 content-block <?php if($loop->have_posts()) echo 'has-feature'; ?>">
                <?php
                if ($loop->have_posts()) :?>
            ...
            <?php else: ?>
            <div class="men-option-1 content-block <?php if($jk_options['men_des_option_1']) echo 'has-feature'; ?>">
            <?php endif;?>
                ...
                <div class="content-block-img">
                    ...
                    <?php endif; ?>
                        ...
                        ?>
                        <picture>
                            <source media="(min-width:992px)" data-srcset="<?php echo $jk_options['men_img_option_1']['url'] ?>">
                            <source media="(min-width:480px)" data-srcset="<?php echo $men_img_option_1_tablet ?>">
                            <img class="lazyload" src="<?php echo $base64_image ?>" data-src="<?php echo $men_img_option_1_mobile ?>" alt="">
                        </picture>
                        <?php endif; ?>
                    <?php if($jk_options['men_url_option_1']): ?>
                    </a>
        ...
        <div class="row">
            ...
            $loop = new WP_Query( $args );
            ?>
            <div class="men-option-2 content-block <?php if ($loop->have_posts()) echo 'has-feature'; ?>">
                <?php
                if ($loop->have_posts()) :?>
                    <div class="feature-product">
                        <?php while ($loop->have_posts()) : $loop->the_post();
                ...
                <?php wp_reset_postdata(); ?>
            <?php else: ?>
            <div class="men-option-2 content-block <?php if($jk_options['men_des_option_2']) echo 'has-feature'; ?>">
            <?php endif;?>
                ...
                <div class="content-block-img">
                    ...
                    <?php endif; ?>
                        ...
                        ?>
                        <picture>
                            <source media="(min-width:992px)" data-srcset="<?php echo $jk_options['men_img_option_2']['url'] ?>">
                            <source media="(min-width:480px)" data-srcset="<?php echo $men_img_option_2_tablet ?>">
                            <img class="lazyload" src="<?php echo $base64_image ?>" data-src="<?php echo $men_img_option_2_mobile ?>" alt="">
                        </picture>
                        <?php endif; ?>
                    <?php if($jk_options['men_url_option_2']): ?>
                    </a>
        ...
        <div class="row">
            ...
            $loop = new WP_Query( $args );
            ?>
            <div class="men-option-3 content-block <?php if ($loop->have_posts()) echo 'has-feature'; ?>">
                <?php
                if ($loop->have_posts()) :?>
                    <div class="feature-product">
                        <?php while ($loop->have_posts()) : $loop->the_post();
                ...
                <?php wp_reset_postdata(); ?>
            <?php else: ?>
            <div class="men-option-3 content-block <?php if($jk_options['men_des_option_3']) echo 'has-feature'; ?>">
            <?php endif;?>
                ...
                <div class="content-block-img">
                    ...
                    <?php endif; ?>
                        ...
                        ?>
                        <picture>
                            <source media="(min-width:992px)" data-srcset="<?php echo $jk_options['men_img_option_3']['url'] ?>">
                            <source media="(min-width:480px)" data-srcset="<?php echo $men_img_option_3_tablet ?>">
                            <img class="lazyload" src="<?php echo $base64_image ?>" data-src="<?php echo $men_img_option_3_mobile ?>" alt="">
                        </picture>
                        <?php endif; ?>
                    <?php if($jk_options['men_url_option_3']): ?>
                    </a>
