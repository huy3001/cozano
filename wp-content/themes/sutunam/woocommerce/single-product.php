...
<div class="right-content">
	...
	<div class="navigation">
		<a href="<?php echo get_permalink(get_adjacent_post(false,'',false)); ?>" class="btn-left-detail"><?php echo __('Sản phẩm trước', 'sutunam') ?></a>
		<?php if($cat->name):?>
		...
		<?php endif;?>
		<a href="<?php echo get_permalink(get_adjacent_post(false,'',true)); ?>" class="btn-right-detail"><?php echo __('Sản phẩm sau', 'sutunam') ?></a>
	</div>
